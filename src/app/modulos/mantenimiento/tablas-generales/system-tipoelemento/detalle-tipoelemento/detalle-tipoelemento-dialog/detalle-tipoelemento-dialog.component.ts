...
@Component({
    selector: 'detalle-tipoelemento-dialog',
    templateUrl: './detalle-tipoelemento-dialog.component.html',
    styleUrls: ['./detalle-tipoelemento-dialog.component.css']
})


export class DetalleTipoElementoDialog implements OnInit {
    ...
    ngAfterViewInit() {
        setTimeout(() => {
            ...
            if (this.dialogConfigData.nIdTipEle != null) {
    ...
    listarTipoElementoxID() {
        ...
        this.pOpcion = 8
        this.pParametro = []
        this.pParametro.push(this.dialogConfigData.nIdTipEle)
    ...
    registrarTipoElemento() {
        ...
        if (this.dialogConfigData.nIdTipEle != null) {
            ...
            this.pParametro.push(this.dialogConfigData.nIdTipEleDad)
            this.pParametro.push(formTipoElemento.sCod)
            this.pParametro.push(formTipoElemento.sDesc)
            this.pParametro.push(formTipoElemento.sAbrev)
            this.pParametro.push(formTipoElemento.nIdPais)
