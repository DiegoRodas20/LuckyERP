...
import { Archivo_Traslado } from '../../registro-traslado/models/registroTraslado.model';
import { RegistroTrasladoService } from '../../registro-traslado/registro-traslado.service';
import { MsgVisorComponent } from '../../registro-traslado/traslado-file/msg-visor/msg-visor.component';
...
@Component({
  selector: 'app-guia-ingreso-file',
  templateUrl: './guia-ingreso-file.component.html',
  styleUrls: ['./guia-ingreso-file.component.css']
})
export class GuiaIngresoFileComponent implements OnInit {
  ...
  lTipoDocumento: Lista_Registro_Ingreso[] = []
  lArchivo: Archivo_Traslado[] = [];
  vRegistro: Lista_Registro_Ingreso;
  sNumero
  vNameRutaFile;
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) private data: Lista_Registro_Ingreso,
    public dialogRef: MatDialogRef<GuiaIngresoFileComponent>,
