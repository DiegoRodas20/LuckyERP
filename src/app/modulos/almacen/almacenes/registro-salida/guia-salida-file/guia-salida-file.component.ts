...
@Component({
  selector: 'app-guia-salida-file',
  templateUrl: './guia-salida-file.component.html',
  styleUrls: ['./guia-salida-file.component.css']
})
export class GuiaSalidaFileComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) private data: Listas_RS,
    public dialogRef: MatDialogRef<GuiaSalidaFileComponent>,
