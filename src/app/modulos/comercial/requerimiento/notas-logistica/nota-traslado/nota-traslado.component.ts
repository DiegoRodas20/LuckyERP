...
export class NotaTrasladoComponent implements OnInit {
  ...
  ListaNotaColumns: string[] =
    ['nIdOperMov', 'sNomPresupuesto', 'sDocumento', 'sOrigen', 'sDestino', 'sFechaTraslado', 'nCantidad', 'nPeso', 'nVolumen', 'sEstado'];
  ...
  async fnListarAnios() {
    ...
    let data = await this.notasLogisticaService.fnControlNotaTraslado
      (1, 2, pParametro, 22, pParametroDet, this.url) as string[];
    this.lAnios = data;
