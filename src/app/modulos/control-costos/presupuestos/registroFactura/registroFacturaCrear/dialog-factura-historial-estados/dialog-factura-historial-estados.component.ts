...
@Component({
  selector: 'app-dialog-factura-historial-estados',
  templateUrl: './dialog-factura-historial-estados.component.html',
  styleUrls: ['./dialog-factura-historial-estados.component.css']
})
export class DialogFacturaHistorialEstadosComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogFacturaHistorialEstadosComponent>,
