...
import { ControlrjPersonalComponent } from '../controlrj-personal/controlrj-personal.component';

// Modals
const MODALS: { [name: string]: Type<any> } = {
  detail: ControlrjPersonalComponent
};

@Component({
  selector: 'app-controlrj-search',
  templateUrl: './controlrj-search.component.html',
  styleUrls: ['./controlrj-search.component.css', './controlrj-search.component.scss'],
})
export class ControlrjSearchComponent implements OnInit {
